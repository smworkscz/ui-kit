...
import type { SpotlightItem, DropdownMenuItem } from '../../src';
import { Sun, Moon, Desktop, MagnifyingGlass } from '@phosphor-icons/react';
...
const THEME_ICONS: Record<ThemePreference, React.ReactNode> = {
  light: <Sun size={16} weight="bold" />,
  dark: <Moon size={16} weight="bold" />,
  system: <Desktop size={16} weight="bold" />,
};
...
const SearchTrigger: React.FC<{ onClick: () => void }> = ({ onClick }) => {
  ...
  return (
    ...
    >
      <MagnifyingGlass size={14} weight="bold" style={{ flexShrink: 0, opacity: 0.6 }} />
