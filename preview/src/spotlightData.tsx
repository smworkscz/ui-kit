...
export const spotlightItems: SpotlightItem[] = [
  ...
  },
  {
    id: 'formwizard',
    label: 'FormWizard',
    description: 'Vícekrokový formulářový průvodce',
    category: 'Navigace',
    icon: <ArrowsClockwise size={ICON_SIZE} />,
    onSelect: () => {},
  },
  ...
  },
  {
    id: 'banner',
    label: 'Banner',
    description: 'Oznámovací banner na celou šířku',
    category: 'Feedback',
    icon: <Warning size={ICON_SIZE} />,
    onSelect: () => {},
  },
  ...
  },
  {
    id: 'phoneinput',
    label: 'PhoneInput',
    description: 'Telefonní vstup s předvolbou země',
    category: 'Formuláře',
    icon: <TextAa size={ICON_SIZE} />,
    onSelect: () => {},
  },
  {
    id: 'imagecropper',
    label: 'ImageCropper',
    description: 'Ořezávání obrázku na canvasu',
    category: 'Formuláře',
    icon: <CursorClick size={ICON_SIZE} />,
    onSelect: () => {},
  },
